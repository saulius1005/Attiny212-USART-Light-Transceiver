...
void GPIO_init() {
	...
	PORTMUX.CTRLB = PORTMUX_USART0_DEFAULT_gc; // use alternate pins for attiny212 othervise usart not work!!!
    ...
    PORTA.PIN7CTRL = PORT_PULLUPEN_bm /*| PORT_INVEN_bm*/;  ///< Enable pull-up resistor for PA7.
}
